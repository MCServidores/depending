...
| :---: | :---: | :---: |
[![Build Status](https://secure.travis-ci.org/toopay/depending.png?branch=master)](http://travis-ci.org/toopay/depending)|[![Build Status](https://secure.travis-ci.org/toopay/depending.png?branch=develop&)](http://travis-ci.org/toopay/depending)|[![Dependencies Status](https://d2xishtp1ojlk0.cloudfront.net/d/8483765)](http://depending.in/toopay/depending)
